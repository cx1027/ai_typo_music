  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        // Backend may fail if local DB user doesn't exist yet
      }
  ...
  return (
    <main className="login-page">
      ...
      <div className="card">
        ...
        <button type="button" onClick={() => handleOAuth("google")} className="btn-oauth">
        ...
        <p className="switch-link">
          ...
          <Link href="/register" className="link-accent">Sign Up</Link>
        </p>
      </div>
    </main>
  );
